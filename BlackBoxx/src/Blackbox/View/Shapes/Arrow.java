...
public class Arrow {
    ...
    public static int[][][] array = {
            { {2, 1, 54}, {52,53},{50,51},{48,49},{45,46,47}},// Top row
            {{4 ,3}, {-1},{-1},{-1},{-1},{43,44}},// Second row
            {{6 ,5}, {-1},{-1},{-1},{-1},{-1},{41,42}},// Third row
            {{8 ,7}, {-1},{-1},{-1},{-1},{-1},{-1},{39,40}},// Fourth row
            {{11 ,10,9}, {-1},{-1},{-1},{-1},{-1},{-1},{-1},{36,37,38}},// Fourth row
            {{13 ,12}, {-1},{-1},{-1},{-1},{-1},{-1},{34,35}},// fifth row
            {{15 ,14}, {-1},{-1},{-1},{-1},{-1},{32,33}},// sixth row
            {{17 ,16}, {-1},{-1},{-1},{-1},{30,31}},// Second row
            {{20, 19, 18}, {22,21},{24,23},{26,25},{29,28,27}}// Top row
    };
